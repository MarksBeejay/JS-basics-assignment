1. JavaScript console can be run in terminal or any command-line interface using Node. In other words, Node.js is an open-source that executes JavaScript outside a web browser.
